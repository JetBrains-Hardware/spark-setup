...
MAX_MODEL_LEN="${QWEN36_BARE_MAX_MODEL_LEN:-65536}"
GPU_MEMORY_UTILIZATION="${QWEN36_BARE_GPU_MEMORY_UTILIZATION:-0.80}"
MAX_NUM_SEQS="${QWEN36_BARE_MAX_NUM_SEQS:-32}"
MAX_NUM_BATCHED_TOKENS="${QWEN36_BARE_MAX_NUM_BATCHED_TOKENS:-8192}"
BLOCK_SIZE="${QWEN36_BARE_BLOCK_SIZE:-16}"
NUM_SPECULATIVE_TOKENS="${QWEN36_BARE_NUM_SPECULATIVE_TOKENS:-1}"
KV_CACHE_DTYPE="${QWEN36_BARE_KV_CACHE_DTYPE:-auto}"
...
ATTENTION_BACKEND="${QWEN36_BARE_ATTENTION_BACKEND:-FLASHINFER}"
